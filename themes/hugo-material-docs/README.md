...
theme should be visible. For detailed installation instructions visit the [demo](https://themes.gohugo.io/theme/material-docs/).
...
A big thank you to [Martin Donath](https://github.com/squidfunk). He created the original [Material theme](https://github.com/squidfunk/mkdocs-material) for Hugo's companion [MkDocs](https://www.mkdocs.org/). This port wouldn't be possible without him.
